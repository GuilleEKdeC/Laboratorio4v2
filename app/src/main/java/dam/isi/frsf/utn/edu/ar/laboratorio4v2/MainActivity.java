...
/*    private Button btnBuscar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Se crea una nueva variable Toolbar tomando como referencia la definida en app_bar_main.xml y se utiliza
          el método setSupportActionBar para indicarle a Android que vamos a utilizar nuestra propia Toolbar.*/
/*        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
*/
        /*Se crea una nueva variable DrawerLayout (contenedor de nuestro "contenido Principal" y de nuestro "navegador"),
          tomando como referencia la definida en activity_main.xml.*/
  //      DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout); //el activity_main.xml
        /*Compatibiliza el Drawer Layout con la barra de acciones (Toolbar)*/
